...
This script trains a simple CNN on the CIFAR-10 dataset and evaluates its performance.
"""
...
class SimpleCNN(nn.Module):
    ...
    def __init__(self, dropout_rate=0.5):
        ...
        # First fully connected layer (CIFAR images are 32x32, after 3 pooling layers: 4x4)
    ...
    def forward(self, x):
        ...
        # Third convolutional block: conv -> relu -> pool
